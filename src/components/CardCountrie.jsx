                                    ...
                                    return (
                                        <article className="card" id={contextTheme === 'light' ? themeColors.light2 : themeColors.dark2} key={index}>
                                            ...
                                            <div className="information-card">
                                                <p className="name-countrie">{country.name.official}</p>
                                                <p className="population-countrie">Population: <span>{country.population.toLocaleString()}</span></p>
                                                <p className="region-countrie">Region: <span>{country.region}</span></p>
                                                <p className="capital-countrie">Capital: <span>{country.capital}</span></p>
                                            </div>
                                        </article>
                                    )
                                })
